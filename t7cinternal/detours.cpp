...
void __fastcall ScriptDetours::VM_OP_GetFunction(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate)
{
    CheckDetour(inst, fs_0);
    VM_OP_GetFunction_Old(inst, fs_0, vmc, terminate);
}

void __fastcall ScriptDetours::VM_OP_GetAPIFunction(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate)
{
...
void __fastcall ScriptDetours::VM_OP_ScriptFunctionCall(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate)
{
    CheckDetour(inst, fs_0, 1);
    VM_OP_ScriptFunctionCall_Old(inst, fs_0, vmc, terminate);
}

void __fastcall ScriptDetours::VM_OP_ScriptMethodCall(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate)
{
    CheckDetour(inst, fs_0, 1);
    VM_OP_ScriptMethodCall_Old(inst, fs_0, vmc, terminate);
}

void __fastcall ScriptDetours::VM_OP_ScriptThreadCall(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate)
{
    CheckDetour(inst, fs_0, 1);
    VM_OP_ScriptThreadCall_Old(inst, fs_0, vmc, terminate);
}

void __fastcall ScriptDetours::VM_OP_ScriptMethodThreadCall(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate)
{
    CheckDetour(inst, fs_0, 1);
    VM_OP_ScriptMethodThreadCall_Old(inst, fs_0, vmc, terminate);
}

void __fastcall ScriptDetours::VM_OP_CallBuiltin(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate)
{
...
void __fastcall ScriptDetours::VM_OP_CallBuiltinMethod(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate)
{
    if (CheckDetour(inst, fs_0, 1))
    {
