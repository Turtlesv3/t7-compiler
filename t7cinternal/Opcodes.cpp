...
void __fastcall Opcodes::VM_OP_GetLazyFunction(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate)
{
...
void __fastcall Opcodes::VM_OP_GetLocalFunction(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate)
{
    INT64 base = (*fs_0 + 3) & 0xFFFFFFFFFFFFFFFCLL;
...
void __fastcall Opcodes::VM_OP_NOP(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate)
{
}