...
private:
    ...
    // Hook functions now match tVM_Opcode signature exactly
    static void __fastcall VM_OP_GetFunction(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate);
    static void __fastcall VM_OP_GetAPIFunction(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate);
    static void __fastcall VM_OP_ScriptFunctionCall(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate);
    static void __fastcall VM_OP_ScriptMethodCall(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate);
    static void __fastcall VM_OP_ScriptThreadCall(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate);
    static void __fastcall VM_OP_ScriptMethodThreadCall(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate);
    static void __fastcall VM_OP_CallBuiltin(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate);
    static void __fastcall VM_OP_CallBuiltinMethod(INT32 inst, INT64* fs_0, INT64 vmc, bool* terminate);
