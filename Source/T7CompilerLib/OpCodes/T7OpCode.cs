...
namespace T7CompilerLib.OpCodes
{
    ...
    public enum ScriptOpCode : byte
    {
        ...
        WaitRealTime = 0x83,
        GetWorldObject = 0x84,
        GetClassesObject = 0x85,
        ClassFunctionCall = 0x86,
        Bit_Not = 0x87,
        GetWorld = 0x88,
        EvalLevelFieldVariable = 0x89,
        EvalLevelFieldVariableRef = 0x8A,
        EvalSelfFieldVariable = 0x8B,
        EvalSelfFieldVariableRef = 0x8C,
        SuperEqual = 0x8D,
        SuperNotEqual = 0x8E,
        New = 0x8F,
        GetUintptr = 0x90,
    ...
    public class ScriptOpMetadata
    {
        ...
        public static readonly ScriptOpMetadata[] OpInfo =
        {
            ...
            new ScriptOpMetadata(ScriptOpCode.New,                              ScriptOpType.StackPush,         ScriptOperandType.Int32),
            new ScriptOpMetadata(ScriptOpCode.GetUintptr,                       ScriptOpType.StackPush,         ScriptOperandType.UInt64),
        };
